<table width="100%" cellpadding="0" cellspacing="0" role="presentation"
    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';background-color:#edf2f7 !important;margin:0;padding:0;width:100%">
    <tbody>
        <tr>
            <td align="center"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td
                                                ...
                                                <p
                                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left; font-weight: bold;">
                                                    Hi <?= $name ?>,</p>
                                                <p
                                                    ...
                                                    Selamat, Anda Telah Registrasi Sebagai Pendaftar Kegiatan Mathematics Event XX. Silahkan Login Menggunakan Pin dan Password  Berikut :</p>
                                                <p
                                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                                    Pin : <?= $pin ?><br>
                                                    Password: <?= $password ?> </p>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td
                                                                                                ...
                                                                                                <a href="<?= base_url('/home/login') ?>"
                                                                                                    ...
                                                                                                    target="_blank"
                                                                                                    data-saferedirecturl="https://www.google.com/url?q=https://app.infinityfree.net/accounts/epiz_26061459&amp;source=gmail&amp;ust=1592777332962000&amp;usg=AFQjCNF-5GGxSEoiOcPbEL66AkGD9E7w-Q">
                                                                                                Login Mathematics Event</a>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                ...
                                                <p
                                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                                    Jika Masih Terdapat Kendala, Silahkan Hubungi Kontak yang Telah disediakan Panitia.</p>
                                                <p
                                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                                    <strong>Ketua Panitia</strong><br>
                                                    Ilmi Kalam</p>
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <p
                                                    ...
                                                    © 2020 Mathematics Event. All rights reserved.</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
